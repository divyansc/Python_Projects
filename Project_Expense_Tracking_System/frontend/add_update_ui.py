...
def add_update_tab():
        ...
        #Creating a form for expense tracking
        with st.form(key="expense_form"): #key used to uniquely identify the form
            col1, col2, col3 = st.columns(3)  # Adjust widths as needed

            # Add subheaders for each column
            with col1:
                st.text("💰 Amount")
            with col2:
                st.text("🗂️ Category")
